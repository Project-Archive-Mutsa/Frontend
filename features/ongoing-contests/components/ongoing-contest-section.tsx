    ...
    <section className="bg-white py-24 sm:py-28 lg:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-14">
        <div className="mx-auto mb-12 max-w-2xl text-center sm:mb-16">
          <p className="text-xs font-bold tracking-[0.2em] text-[#5b7b98] uppercase">
            Now Open
          </p>
          <h2 className="mt-3 text-4xl font-bold tracking-[-0.05em] text-[#122c45] sm:text-5xl">
            진행 중인 공모전
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-sm leading-7 text-[#6b7680] sm:text-base">
