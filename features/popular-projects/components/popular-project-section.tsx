...
export default function PopularProjectSection() {
  return (
    <section className="border-y border-[#dce9f2] bg-brand-canvas py-16 sm:py-20">
      <div className="mx-auto max-w-6xl px-5 sm:px-8 lg:px-10">
        <div className="mb-10 flex flex-col gap-3 sm:mb-12 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h2 className="text-balance break-keep text-3xl font-bold tracking-[-0.04em] text-[#152f49] sm:text-4xl">
              인기 프로젝트
            </h2>
          </div>
          <p className="max-w-md text-pretty break-keep text-sm leading-6 text-[#6c757d] sm:text-right">
