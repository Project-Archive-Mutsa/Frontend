...
import { getMyRecruitmentApplications } from "../api/mypage-api";
...
export default function TeamApplicationsSection() {
  ...
  const query = useQuery({ queryKey: queryKeys.mypage.applications, queryFn: getMyRecruitmentApplications, enabled: Boolean(user) });
